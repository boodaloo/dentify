...
const mockRegistries = [
  { id: 1, regNum: 'OMS-2026-003', period: 'February 2026', type: 'OMS', records: 142, amount: 284000, submitted: '01 Mar 2026', status: 'accepted' },
  { id: 2, regNum: 'DMS-2026-009', period: 'February 2026', type: 'DMS', records: 38, amount: 95000, submitted: '02 Mar 2026', status: 'submitted' },
  { id: 3, regNum: 'OMS-2026-002', period: 'January 2026', type: 'OMS', records: 156, amount: 312000, submitted: '01 Feb 2026', status: 'accepted' },
  { id: 4, regNum: 'DMS-2026-008', period: 'January 2026', type: 'DMS', records: 45, amount: 112500, submitted: '03 Feb 2026', status: 'rejected' },
  { id: 5, regNum: 'OMS-2026-001', period: 'December 2025', type: 'OMS', records: 134, amount: 268000, submitted: '02 Jan 2026', status: 'accepted' },
];
  ...
  return (
    <div className="sp-page">
      <div className="sp-header">
        <div>
          <h1>OMS / DMS Registries</h1>
          <p>Submission registries for mandatory and voluntary medical insurance</p>
        </div>
          ...
          <tbody>
            {mockRegistries.map(r => (
              <tr key={r.id}>
                ...
                <td>{r.period}</td>
                <td>
                  <span className={`sp-badge ${r.type === 'OMS' ? 'sp-badge-teal' : 'sp-badge-blue'}`}>
                    {r.type}
                  </span>
                </td>
                <td>{r.records}</td>
