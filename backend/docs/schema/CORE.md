...
## База: orisios_internal (Админка Orisios)
...
-- Клиники (мастер-данные, источник clinic_id для orisios_app)
adm_clinics
...
```
┌─────────────────────────────────────────────────────────────┐
│  🦷 Orisios    [■ ЛЕН Филиал на Ленина ▼]    🔔  👤 Иванов │
├─────────────────────────────────────────────────────────────┤
│                                                             │
```
...
- Передача владения — через поддержку Orisios

---

## База: orisios_app — Пациенты
